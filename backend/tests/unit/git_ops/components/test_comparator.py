...
class TestPostComparator:
    ...
    def test_compare_datetime_mismatch(self):
        """测试时间不一致"""
    ...
    def test_compare_datetime_normalization(self):
        """
        测试时间规范化逻辑（重点防止回归）
    ...
    def test_compare_enum_normalization(self):
        """测试枚举规范化逻辑"""
    ...
    def test_compare_uuid_normalization(self):
        """测试 UUID 规范化"""
        uid = uuid4()
    ...
    def test_compare_content_change(self):
        """测试内容变更"""
