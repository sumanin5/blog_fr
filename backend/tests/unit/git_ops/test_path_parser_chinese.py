...
@pytest.mark.unit
def test_parse_chinese_category_slug(parser):
    """测试中文目录名被正确转换为拼音 slug"""
    # 测试中文目录名
...
@pytest.mark.unit
def test_parse_mixed_chinese_english_category(parser):
    """测试中英文混合的分类目录名"""
...
@pytest.mark.unit
def test_parse_english_category_unchanged(parser):
    """测试英文分类目录名保持不变"""
...
@pytest.mark.unit
def test_parse_category_with_spaces(parser):
    """测试带空格的分类目录名"""
...
@pytest.mark.unit
def test_parse_category_with_special_chars(parser):
    """测试带特殊字符的分类目录名"""
...
@pytest.mark.unit
def test_parse_index_md_chinese_category(parser):
    """测试中文分类的 index.md"""
