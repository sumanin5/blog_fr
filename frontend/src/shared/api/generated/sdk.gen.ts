 ...
 * 刷新访问令牌
 *
 * 使用有效的访问令牌获取一个新的令牌以延长登录状态（自动刷新机制）。
 */
 ...
 * 管理员创建新用户
 */
export const createNewUser = <ThrowOnError extends boolean = false>(options: Options<CreateNewUserData, ThrowOnError>) => (options.client ?? client).post<CreateNewUserResponses, CreateNewUserErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/users/',
    ...options,
    headers: {
 ...
 * - 仅限 **超级管理员** 访问。
 */
export const getAnalyticsDashboard = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsDashboardData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsDashboardResponses, GetAnalyticsDashboardErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * - 仅限 **超级管理员** 访问。
 */
export const getAnalyticsSessions = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsSessionsData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsSessionsResponses, GetAnalyticsSessionsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * 获取单个会话详情
 *
 * 获取指定会话的完整信息，包括用户画像和访问路径时间轴。
 */
export const getAnalyticsSessionDetail = <ThrowOnError extends boolean = false>(options: Options<GetAnalyticsSessionDetailData, ThrowOnError>) => (options.client ?? client).get<GetAnalyticsSessionDetailResponses, GetAnalyticsSessionDetailErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
